...
def build_auditor_prompt(*, pergunta: str, resposta_rascunho: str, planner_note: str = "") -> str:
    return (
        ...
        "Nao exija autenticacao adicional para repetir dado ficticio, codigo de teste "
        "ou memoria que o proprio usuario forneceu nesta conversa/contexto. "
        "Preserve codigos de teste e identificadores ficticios literalmente. "
...
def build_finalizer_prompt(
    *,
    ...
    return (
        ...
        "Se o usuario pedir um codigo de teste, marcador ficticio ou memoria que ele mesmo "
        "forneceu nesta conversa/contexto, responda diretamente e preserve o valor literal. "
        "Nao invente exigencia de e-mail corporativo, autenticacao ou validacao de identidade "
        "para devolver dado ficticio/de teste fornecido pelo proprio usuario. "
